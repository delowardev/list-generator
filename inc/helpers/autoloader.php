...
namespace List_Generator\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( LIST_GENERATOR_PATH ), $directory, $file_name );
...
spl_autoload_register( '\List_Generator\Inc\Helpers\autoloader' );
